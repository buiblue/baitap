...
CREATE DATABASE [QuanLyDeAn]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'QuanLyDeAn_Data', FILENAME = N'C:\letrandieuhoa\QuanLyDeAn_Data.mdf' , SIZE = 20480KB , MAXSIZE = 1024000KB , FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'QuanLyDeAn_log', FILENAME = N'C:\letrandieuhoa\QuanLyDeAn_Log.ldf' , SIZE = 6144KB , MAXSIZE = 20480KB , FILEGROWTH = 5%)
